    ...
    final databaseOptions = sqflite.OpenDatabaseOptions(
      ...
      onCreate: (database, version) async {
        await database.execute(
            'CREATE TABLE IF NOT EXISTS `Employee` (`id` INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, `name` TEXT NOT NULL, `address` TEXT NOT NULL, `salary` REAL NOT NULL)');
...
class _$EmployeeDao extends EmployeeDao {
  ...
  @override
  Future<Employee?> getSpecificEmployee(int id) async {
  ...
  @override
  Future<void> saveUser(Employee employee) async {
    await _employeeInsertionAdapter.insert(employee, OnConflictStrategy.abort);
  }

  @override
  Future<void> updateUser(Employee employee) async {
